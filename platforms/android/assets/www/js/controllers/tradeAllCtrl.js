...
define(['./module', '../modules/validate-tips', '../services/trade'], function(controllers, messages, trade) {
	controllers.controller('tradeAllCtrl', function($scope, $http, $ionicLoading, $timeout, trade) {
		...
		$http.get('../../json/trade.json', {cache: true, params: {'page': 'all'} })
